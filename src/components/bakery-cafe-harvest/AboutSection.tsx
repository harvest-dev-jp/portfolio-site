...
export default function AboutSection() {
  return (
    <section id="about" className="scroll-mt-32 bg-[#F7F3EA] px-4 py-20 sm:px-6 lg:px-8">
        ...
        <ScrollReveal>
          ...
          <div className="mt-4 grid gap-8 lg:grid-cols-[1fr_0.85fr] lg:items-center">
            <div>
              ...
              <div className="mt-6 space-y-4 text-base leading-8 text-[#333333]">
                <p>
            ...
            <Image
              src="/works/bakery-cafe-harvest/about-bakery.jpg"
              alt="自然光の入る木のテーブルに焼きたてパンを並べたイメージ"
              width={720}
              height={540}
